use crate::application::stt_providers::create_stt_provider;
use crate::application::stt_providers::AudioCaptureConfig;
use crate::application::stt_providers::SttProviderSettings;
use crate::application::stt_providers::SttResultCallback;
use crate::application::stt_providers::SttTranscriptResult;
use crate::db::stt_provider as stt_provider_repo;
use crate::db::transcript as transcript_repo;
use crate::domain::transcriptions::TranscriptionResult;
use crate::error::log_err;
use crate::infra::audio_capture::AudioInput;
use crate::infra::audio_capture::AudioStream;
